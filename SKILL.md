...
📄 学习材料共 156 页，平均每页约 0.3 个知识点
⏱️ 预计耗时：约 15-20 分钟

⚠️ 知识点数量检查：
- 转型概述：6 个知识点 / 12 页 → ⚠️ 比例偏高，建议合并
- 客户战略：3 个知识点 / 28 页 → ✅ 比例合理
...
- 正确：`- 数字化与转型的定义区分`
- 错误：`- 数字化与转型的定义区分：数字化是技术升级...` （包含解释）
- 错误：`- 数字化与转型的定义区分 [[来源：文档，第5页]]` （包含引用）
...
1. 按 H2/H3 层级创建文件夹结构
2. 在**每个 H3 主题文件夹内**创建 MOC 笔记
3. 为每个 bullet 知识点创建原子笔记文件（放在对应 H3 文件夹内）
